...
public class assetCreationPage extends BaseClass {
	...
	private void initElements() {
		...
		CreateAssetPageTitle = driver.findElementByAccessibilityId("NewAssertHeader");   //pageTitle Asset Details
		...
		AssetSaveBtn = driver.findElementByAccessibilityId("SaveButton");
		AssetClearBtn = driver.findElementByAccessibilityId("CancelButton");
	...
	public String getAssetManufacturertext_0() {
		return FetchText(AssetEditBox.get(0));
	}
	...
	public String getAssetLocationtext() {
		return FetchText(AssetEditBox.get(2));
	}
	
	public String getAssetLocationtext_0() {
		return FetchText(AssetEditBox.get(0));
	}
	...
	public String getAssetSizeUnittext() {
		return AssetEditBox.get(3).getText();
	}
	...
	// Click Image1 Placeholder button
		public void click_Img2_Placeholder_Btn() throws InterruptedException {
			clickOn(AssetImg2_Btn);
			Thread.sleep(500);
		}
	// Click Image1 Placeholder button
		public void click_Img3_Placeholder_Btn() throws InterruptedException {
			clickOn(AssetImg3_Btn);
			Thread.sleep(500);
		}
	...
	public void upload_Images(String filename) throws AWTException, IOException, InterruptedException {
		...
		{	
			...
			act.sendKeys(alert, filepath).perform();
		}
	...
	public void image_Upload(String filename) throws InterruptedException
	{
		WebElement alert = driver.switchTo().activeElement();
		Thread.sleep(1000);
		String filepath = System.getProperty("user.dir") + "\\src\\test\\resources\\TestData\\" + filename;
	...
	public void capture_Camera_Img() throws InterruptedException {
		...
		Thread.sleep(500);
		WebElement Click_Camera_Wdw_Accept_Btn = driver.findElementByAccessibilityId("AcceptButton");
	...
	// Asset Creation with Mandatory fields
		public void assetCreation_WithoutSave(String AName, String AID, String AType, String AManufaturer, String ALocation)
				throws InterruptedException {
			enterAssetName(AName);
			enterAssetID(AID);
			SelectAssetType(AType);
	...
	// Asset Creation with all Data entry
		public void assetCreationWithAllFieldEntry1(String AName, String AID, String AType, String AManufacturer,
				String ALocation, String AModel, String ASize, String AUnit, String ALVDate, String AFreq, String AFreqInt,
				String ADesc) throws InterruptedException {
	...
	public void clearUserId() {
		WebElement UserId=driver.findElementByAccessibilityId("UserIdTextBox");
		UserId.clear();
	...
	public void clearUserpwd() {
		WebElement UserPswd=driver.findElementByAccessibilityId("PasswordTextBox");
		UserPswd.clear();
