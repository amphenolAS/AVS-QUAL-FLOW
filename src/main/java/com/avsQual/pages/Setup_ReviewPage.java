...
public class Setup_ReviewPage extends BaseClass {
	...
	WebElement CalDevCri = null;
	WebElement VerDevCri = null;
	WebElement StabCri = null;
	WebElement TempSetpoit = null;
	WebElement EditCalPara = null;
	WebElement DataStorage = null;
	WebElement ClkAdjstmnt = null;
	...
	private void initializeEelements() {
		...
		Previous_Btn = driver.findElementByAccessibilityId("PreviuosButton");
		...
		image = driver.findElementByClassName("Image");
		Asset_ID = driver.findElementByAccessibilityId("EquipmentIDTextBlock");//Asset ID EquipmentIDTextBlock
		Model = driver.findElementByAccessibilityId("ModelNoTextBlock");
		Manufacturer = driver.findElementByAccessibilityId("ManufacturerTextBlock");
		Type = driver.findElementByAccessibilityId("TypeTextBlock");
		Size = driver.findElementByAccessibilityId("SizeTextBlock");
		Temp = driver.findElementByAccessibilityId("TempTextBlockValue");
...
//		Temp_val = driver.findElementByAccessibilityId("TempkValueTextBlock");
		...
		Asset_ID_Report = driver.findElementByXPath("//*[normalize-space(.='Asset ID #')]");
		...
		CalDevCri = driver.findElementByName("Calibration Deviation Criteria");
		VerDevCri = driver.findElementByName("Verification Deviation Criteria");
		StabCri = driver.findElementByName("Stability Criteria");
		TempSetpoit = driver.findElementByName("Temperature Setpoints");
		EditCalPara = driver.findElementByAccessibilityId("EditCalibrationParametersButton");
		DataStorage = driver.findElementByName("Data Storage");
		ClkAdjstmnt = driver.findElementByName("Clock Adjustment");
	...
	public boolean is_SetupNameVisible()
	{
		return IsElementVisibleStatus(SetupHeaderTextBlock);
	}
	...
	public String get_CalParametersTitle()
	{
		WebElement calPara = driver.findElementByName("Cal/Ver Parameters");
		return FetchText(calPara);
	}
	public String get_QualParametersTitle()
	{
		WebElement qualPara = driver.findElementByName("Qualification Parameters");
		return FetchText(qualPara);
	}
	public String get_DataStorageTitleText()
	{
		return FetchText(DataStorage);
	}
	public String get_ClkAdjstmntTitleText()
	{
		return FetchText(ClkAdjstmnt);
	}
	public String get_RelayTitleText()
	{
		return FetchText(Relay);
	}
...
//	// Click the bottom vertical scroll bar
//		public void click_Scrollbar() {
//			WebElement arrow = driver.findElementByName("Qualification Parameters");// 
//			
//			click_bottom_Scrollbar(1);
//			
//			Actions act = new Actions(driver);
//			
//			if(!arrow.isDisplayed())
//			{
//				WebElement arrow1 = driver.findElementById("VerticalThumb");
//				//act.clickAndHold(arrow1).build().perform();
//				act.sendKeys(null)
//			}
//			
//		}
	...
	public boolean is_CalDevCriDisplays()
	{
		return IsElementVisibleStatus(CalDevCri);
	}
	public boolean is_VerDevCriDisplays()
	{
		return IsElementVisibleStatus(VerDevCri);
	}
	public boolean is_StabCriDisplays()
	{
		return IsElementVisibleStatus(StabCri);
	}
	public boolean is_TempSetPntDisplays()
	{
		return IsElementVisibleStatus(TempSetpoit);
	}
...
//		WebElement dismissBtn = driver.findElementByAccessibilityId("DismissButton");
//		clickOn(dismissBtn);
//		Thread.sleep(1000);
...
//		clickOn(setupsave);
	...
	public void click_SaveCopySetup()
	{
		WebElement setupsave = driver.findElementByAccessibilityId("CopySetupSaveButton");
		clickOn(setupsave);
	}
	
	public void click_CacleCopySetup()
	{
		WebElement setupcancel = driver.findElementByAccessibilityId("CopySetupCancelButton");
		clickOn(setupcancel);
	}
...
//Group name temp is displayed
	...
	//click on EditCalPara
	public Setup_CalVerParametersPage click_EditCalParaEditBttn() throws IOException
	{
		clickOn(EditCalPara);
	...
	public boolean is_ImageDisplayed()
	{
		return IsElementVisibleStatus(image);
	}
	public String getText_InternCal()
	{
		WebElement ele = driver.findElementByName("Interval Calculations");
		return FetchText(ele);
	}
	public String getText_SatPandTCal()
	{
		WebElement ele = driver.findElementByAccessibilityId("SaturationPTCalculationsTextBlock");
		return FetchText(ele);
	}
	public String getText_ReqTextBlkFrmReviwPage(String name) throws InterruptedException
	{
		String text = "";

		List<WebElement> textBlock = driver.findElementsByClassName("TextBlock");
		for(WebElement string:textBlock)
		{
			text = FetchText(string);
	...
	public void click_NextOnImage()
	{
		WebElement imag = driver.findElementByAccessibilityId("NextButtonHorizontal");
		clickOn(imag);
	}
	//asset image dispalyed or not on review page
	public boolean assetImages_Displayed()
	{
		WebElement images = driver.findElementByAccessibilityId("AssetImagesFlipView");
		return IsElementVisibleStatus(images);
	}
