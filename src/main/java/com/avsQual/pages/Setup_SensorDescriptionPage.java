...
public class Setup_SensorDescriptionPage extends BaseClass {
	...
	void initializeEelements() {
		SensorDescriptionPageName = driver.findElementByAccessibilityId("txbSensorDescription");
		SelectSensorTypeBy_field = driver.findElementByAccessibilityId("AllSensorsChkBox");
		...
		Close_button = driver.findElementByAccessibilityId("DescriptionCancelButton");
		Ok_button = driver.findElementByAccessibilityId("DescriptionOkButton");
		AutoNumberCheckBox = driver.findElementByAccessibilityId("DescriptionAutoNumberCheckBox");
		//SensorType_ComboBox = driver.findElementByAccessibilityId("SensorTypeSimComboBox");

		clear_btn = driver.findElementByAccessibilityId("ClearDescriptionButton");
	...
	// Check the presence of SelectSensorTypeBy_field
	public boolean IsSelectSensorTypeByHeader_Clickable() {
		return checkboxSelectStatus(SelectSensorTypeBy_field);
	}
	...
	//click select all sensors button
	public void click_SelectAllSensors()
	{
	...
	//click on auto number check box
	public void click_AutoNumberChkBox()
	{
		clickOn(AutoNumberCheckBox);
	}
	...
	public String get_LeftDescriptionext(int index) {
		List<WebElement> senrList = driver.findElementByAccessibilityId("PART_ScrollViewer")
				.findElements(By.className("TextBlock"));
...
//Fetch data from txtTo field
	...
	//	WebElement Description_field = driver.findElementByAccessibilityId("ContentElement");
		clickOn(Description_Txtfield);
		ClearText(Description_Txtfield);
		enterText(Description_Txtfield, Dsc);
	}
	...
	public String get_Description_text() {
		...
		return FetchText(Description_Txtfield);
	}
